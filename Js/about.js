 ...
 displayValue.forEach((displayValue) => {
  ...
  ScrollReveal({
    ...
    delay:200
       ...
       ScrollReveal().reveal('.count-icons-1, .count-icons-3', { delay: 50, origin: 'top' });
       ScrollReveal().reveal('#home-link, .product-link, .about-img, #count-2, .customer-1, .customer-4, .copyright', { delay: 50, origin: 'left' });
       ScrollReveal().reveal('.programmer, #about-link, .about-content, #count-4', { delay: 50, origin: 'right' });
       ScrollReveal().reveal('.intro-text-1, .count-icons-2, .count-icons-4', { delay: 50, origin: 'bottom' });
